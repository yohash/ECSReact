...
namespace ECSReact.Samples.BattleSystem
{
  ...
  public partial struct SaveBattleMiddleware_System : ISystem
  {
    ...
    private ComponentLookup<ECSReact.Samples.BattleSystem.SaveBattleAction> actionLookup;
    ...
    public void OnCreate(ref SystemState state)
    {
      ...
      actionLookup = state.GetComponentLookup<ECSReact.Samples.BattleSystem.SaveBattleAction>(isReadOnly: false);
    ...
    private void ProcessMiddleware(
      ...
      ComponentLookup<ECSReact.Samples.BattleSystem.SaveBattleAction> actionLookup)
    {
