...
namespace ECSReact.Samples.BattleSystem
{
  ...
  public static class StoreExtensions
  {
    ...
    /// <summary>
    /// Dispatch a EndBattleAction to the ECS world.
    /// </summary>
    /// <param name="PlayerWon">The PlayerWon value for the action.</param>
    /// <returns>True if the action was dispatched successfully, false if Store instance is not available.</returns>
    public static bool EndBattle(this Store store, bool PlayerWon)
    {
      if (store == null)
      {
        UnityEngine.Debug.LogError("Store instance is null when dispatching EndBattleAction");
        return false;
      }

      var action = new EndBattleAction
      {
        PlayerWon = PlayerWon,
      };
    ...
    /// <summary>
    /// Dispatch a EndBattleAction using the Store singleton instance.
    /// </summary>
    /// <param name="PlayerWon">The PlayerWon value for the action.</param>
    /// <returns>True if the action was dispatched successfully, false if Store instance is not available.</returns>
    public static bool EndBattle(bool PlayerWon)
    {
      if (Store.Instance == null)
      {
        UnityEngine.Debug.LogError("Store.Instance is null when dispatching EndBattleAction");
      ...
      return Store.Instance.EndBattle(PlayerWon);
    }
    ...
    /// </summary>
    /// <param name="nextCharacterIndex">The nextCharacterIndex value for the action.</param>
    /// <param name="isPlayerTurn">The isPlayerTurn value for the action.</param>
    /// <returns>True if the action was dispatched successfully, false if Store instance is not available.</returns>
    public static bool NextTurn(this Store store, int nextCharacterIndex, bool isPlayerTurn)
    {
      if (store == null)
      {
    ...
    /// <param name="isPlayerTurn">The isPlayerTurn value for the action.</param>
    /// <returns>True if the action was dispatched successfully, false if Store instance is not available.</returns>
    public static bool NextTurn(int nextCharacterIndex, bool isPlayerTurn)
    {
      if (Store.Instance == null)
      {
        UnityEngine.Debug.LogError("Store.Instance is null when dispatching NextTurnAction");
      ...
      return Store.Instance.NextTurn(nextCharacterIndex, isPlayerTurn);
    }

    /// <summary>
    /// Dispatch a ReadyForNextTurn to the ECS world.
    /// </summary>
    /// <returns>True if the action was dispatched successfully, false if Store instance is not available.</returns>
    public static bool ReadyForNextTurn(this Store store)
    {
      if (store == null)
      {
        UnityEngine.Debug.LogError("Store instance is null when dispatching ReadyForNextTurn");
        return false;
      }

      var action = new ReadyForNextTurn
      {
      };
    ...
    /// <summary>
    /// Dispatch a ReadyForNextTurn using the Store singleton instance.
    /// </summary>
    /// <returns>True if the action was dispatched successfully, false if Store instance is not available.</returns>
    public static bool ReadyForNextTurn()
    {
      if (Store.Instance == null)
      {
        UnityEngine.Debug.LogError("Store.Instance is null when dispatching ReadyForNextTurn");
      ...
      return Store.Instance.ReadyForNextTurn();
    }
