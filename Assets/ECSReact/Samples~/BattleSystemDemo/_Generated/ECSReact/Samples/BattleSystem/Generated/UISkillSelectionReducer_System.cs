...
namespace ECSReact.Samples.BattleSystem
{
  ...
  public partial struct UISkillSelectionReducer_System : ISystem
  {
    ...
    private ComponentLookup<SelectSkillAction> actionLookup;
    ...
    public void OnCreate(ref SystemState state)
    {
      ...
      actionLookup = state.GetComponentLookup<SelectSkillAction>(isReadOnly: true);
    ...
    private void ProcessActions(
      ...
      ComponentLookup<SelectSkillAction> actionLookup)
    {
      ...
      var type = new ComponentType(typeof(SelectSkillAction));
      ...
      foreach (var entity in entities)
      {
        if (isZeroSized) {
          ...
          var action = default(SelectSkillAction);
