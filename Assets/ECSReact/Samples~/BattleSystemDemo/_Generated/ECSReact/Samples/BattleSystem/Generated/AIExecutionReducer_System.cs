...
namespace ECSReact.Samples.BattleSystem
{
  ...
  /// Action: ECSReact.Samples.BattleSystem.AIDecisionMadeAction
  /// </summary>
  ...
  public partial struct AIExecutionReducer_System : ISystem
  {
    ...
    private ComponentLookup<ECSReact.Samples.BattleSystem.AIDecisionMadeAction> actionLookup;
    ...
    public void OnCreate(ref SystemState state)
    {
      ...
      var queryBuilder = new EntityQueryBuilder(Allocator.Temp)
        .WithAll<ECSReact.Samples.BattleSystem.AIDecisionMadeAction, ActionTag>();
      actionQuery = state.GetEntityQuery(queryBuilder);
      queryBuilder.Dispose();

      // Create ComponentLookup once for reuse
      actionLookup = state.GetComponentLookup<ECSReact.Samples.BattleSystem.AIDecisionMadeAction>(isReadOnly: true);
    ...
    private void ProcessActions(
      ...
      ComponentLookup<ECSReact.Samples.BattleSystem.AIDecisionMadeAction> actionLookup)
    {
      ...
      var type = new ComponentType(typeof(ECSReact.Samples.BattleSystem.AIDecisionMadeAction));
      ...
      foreach (var entity in entities)
      {
        if (isZeroSized) {
          ...
          var action = default(ECSReact.Samples.BattleSystem.AIDecisionMadeAction);
