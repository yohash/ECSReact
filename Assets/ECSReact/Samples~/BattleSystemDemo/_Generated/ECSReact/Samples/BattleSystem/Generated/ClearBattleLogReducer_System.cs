...
namespace ECSReact.Samples.BattleSystem
{
  ...
  /// Action: ECSReact.Samples.BattleSystem.ClearBattleLogAction
  /// </summary>
  ...
  public partial struct ClearBattleLogReducer_System : ISystem
  {
    ...
    private ComponentLookup<ECSReact.Samples.BattleSystem.ClearBattleLogAction> actionLookup;
    ...
    public void OnCreate(ref SystemState state)
    {
      ...
      var queryBuilder = new EntityQueryBuilder(Allocator.Temp)
        .WithAll<ECSReact.Samples.BattleSystem.ClearBattleLogAction, ActionTag>();
      actionQuery = state.GetEntityQuery(queryBuilder);
      queryBuilder.Dispose();

      // Create ComponentLookup once for reuse
      actionLookup = state.GetComponentLookup<ECSReact.Samples.BattleSystem.ClearBattleLogAction>(isReadOnly: true);
    ...
    private void ProcessActions(
      ...
      ComponentLookup<ECSReact.Samples.BattleSystem.ClearBattleLogAction> actionLookup)
    {
      ...
      var type = new ComponentType(typeof(ECSReact.Samples.BattleSystem.ClearBattleLogAction));
      ...
      foreach (var entity in entities)
      {
        if (isZeroSized) {
          ...
          var action = default(ECSReact.Samples.BattleSystem.ClearBattleLogAction);
