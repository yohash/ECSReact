...
namespace ECSReact.Samples.BattleSystem
{
  ...
  public partial struct EndBattleMiddleware_System : ISystem
  {
    ...
    private ComponentLookup<EndBattleAction> actionLookup;
    ...
    public void OnCreate(ref SystemState state)
    {
      ...
      var queryBuilder = new EntityQueryBuilder(Allocator.Temp)
        .WithAll<EndBattleAction, ActionTag>();
      actionQuery = state.GetEntityQuery(queryBuilder);
      queryBuilder.Dispose();

      actionLookup = state.GetComponentLookup<EndBattleAction>(isReadOnly: false);
      state.RequireForUpdate(actionQuery);
      state.RequireForUpdate<EndBattleAction>();
    }
    ...
    private void ProcessMiddleware(
      ...
      ComponentLookup<EndBattleAction> actionLookup)
    {
      ...
      var type = new ComponentType(typeof(EndBattleAction));
      ...
      foreach (var entity in entities)
      {
        ...
        if (isZeroSized)
        {
          ...
          var action = default(EndBattleAction);
