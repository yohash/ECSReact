...
namespace ECSReact.Samples.BattleSystem
{
  ...
  public partial struct AIDecisionReducer_System : ISystem
  {
    ...
    private ComponentLookup<AIReadyToDecideAction> actionLookup;
    ...
    public void OnCreate(ref SystemState state)
    {
      ...
      actionLookup = state.GetComponentLookup<AIReadyToDecideAction>(isReadOnly: true);
    ...
    private void ProcessActions(
      ...
      ComponentLookup<AIReadyToDecideAction> actionLookup)
    {
      ...
      var type = new ComponentType(typeof(AIReadyToDecideAction));
      ...
      foreach (var entity in entities)
      {
        if (isZeroSized) {
          ...
          var action = default(AIReadyToDecideAction);
