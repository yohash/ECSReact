...
namespace ECSReact.Samples.BattleSystem
{
  ...
  /// Type: IReducer
  /// State: CharacterManaState, Action: CharacterCreatedAction
  /// </summary>
  ...
  public partial struct CharacterManaReducer_System : ISystem
  {
    ...
    public void OnCreate(ref SystemState state)
    {
      ...
      state.RequireForUpdate<CharacterManaState>();
      state.RequireForUpdate(actionQuery);
    }

    public void OnUpdate(ref SystemState state)
    {
      var gameState = SystemAPI.GetSingletonRW<CharacterManaState>();
    ...
    private void ProcessActions(
      ...
      RefRW<CharacterManaState> gameState,
