...
namespace ECSReact.Samples.BattleSystem
{
  ...
  /// Type: IReducer
  /// State: AIThinkingState, Action: EnemyTurnStartedAction
  /// </summary>
  ...
  public partial struct AIThinkingStartReducer_System : ISystem
  {
    ...
    private ComponentLookup<EnemyTurnStartedAction> actionLookup;
    ...
    public void OnCreate(ref SystemState state)
    {
      ...
      var queryBuilder = new EntityQueryBuilder(Allocator.Temp)
        .WithAll<EnemyTurnStartedAction, ActionTag>();
      actionQuery = state.GetEntityQuery(queryBuilder);
      queryBuilder.Dispose();

      // Create ComponentLookup once for reuse
      actionLookup = state.GetComponentLookup<EnemyTurnStartedAction>(isReadOnly: true);
    ...
    private void ProcessActions(
      ...
      ComponentLookup<EnemyTurnStartedAction> actionLookup)
    {
      ...
      var type = new ComponentType(typeof(EnemyTurnStartedAction));
      ...
      foreach (var entity in entities)
      {
        if (isZeroSized) {
          ...
          var action = default(EnemyTurnStartedAction);
