...
namespace ECSReact.Samples.BattleSystem
{
  ...
  public partial struct BattleLogReducer_System : ISystem
  {
    ...
    private ComponentLookup<BattleLogAction> actionLookup;
    ...
    public void OnCreate(ref SystemState state)
    {
      ...
      actionLookup = state.GetComponentLookup<BattleLogAction>(isReadOnly: true);
    ...
    private void ProcessActions(
      ...
      ComponentLookup<BattleLogAction> actionLookup)
    {
      ...
      var type = new ComponentType(typeof(BattleLogAction));
      ...
      foreach (var entity in entities)
      {
        if (isZeroSized) {
          ...
          var action = default(BattleLogAction);
