...
namespace ECSReact.Samples.BattleSystem
{
  ...
  public partial struct TurnOrderReducer_System : ISystem
  {
    ...
    private ComponentLookup<InitializeTurnOrderAction> actionLookup;
    ...
    public void OnCreate(ref SystemState state)
    {
      ...
      actionLookup = state.GetComponentLookup<InitializeTurnOrderAction>(isReadOnly: true);
    ...
    private void ProcessActions(
      ...
      ComponentLookup<InitializeTurnOrderAction> actionLookup)
    {
      ...
      var type = new ComponentType(typeof(InitializeTurnOrderAction));
      ...
      foreach (var entity in entities)
      {
        if (isZeroSized) {
          ...
          var action = default(InitializeTurnOrderAction);
