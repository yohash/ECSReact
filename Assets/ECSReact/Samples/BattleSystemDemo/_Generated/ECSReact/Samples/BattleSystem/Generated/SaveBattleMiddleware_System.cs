...
namespace ECSReact.Samples.BattleSystem
{
  ...
  public partial struct SaveBattleMiddleware_System : ISystem
  {
    ...
    private ComponentLookup<SaveBattleAction> actionLookup;
    ...
    public void OnCreate(ref SystemState state)
    {
      ...
      actionLookup = state.GetComponentLookup<SaveBattleAction>(isReadOnly: false);
    ...
    private void ProcessMiddleware(
      ...
      ComponentLookup<SaveBattleAction> actionLookup)
    {
      ...
      var type = new ComponentType(typeof(SaveBattleAction));
      ...
      foreach (var entity in entities)
      {
        ...
        if (isZeroSized)
        {
          ...
          var action = default(SaveBattleAction);
