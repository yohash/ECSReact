...
// Generated from: UISkillSelectionReducer
...
{
  /// <summary>
  /// Generated bridge for standard reducer: UISkillSelectionReducer
  /// Provides zero-allocation iteration using SystemAPI.Query.
  /// </summary>
  [UpdateInGroup(typeof(ReducerSystemGroup))]
  internal partial class UISkillSelectionReducer_SelectSkillAction_Bridge : SystemBase
  {
    private UISkillSelectionReducer userReducer;

    protected override void OnCreate()
    {
      base.OnCreate();
      RequireForUpdate<UIBattleState>();
      RequireForUpdate<SelectSkillAction>();

      userReducer = World.GetOrCreateSystemManaged<UISkillSelectionReducer>();
    ...
    protected override void OnUpdate()
    {
      ...
      foreach (var (action, entity) in
               SystemAPI.Query<RefRO<SelectSkillAction>>()
                 .WithAll<ActionTag>()
                 .WithEntityAccess())
      {
