...
namespace ECSReact.Samples.BattleSystem
{
  ...
  public partial struct UICancelActionReducer_System : ISystem
  {
    ...
    private ComponentLookup<CancelActionAction> actionLookup;
    ...
    public void OnCreate(ref SystemState state)
    {
      ...
      actionLookup = state.GetComponentLookup<CancelActionAction>(isReadOnly: true);
    ...
    private void ProcessActions(
      ...
      ComponentLookup<CancelActionAction> actionLookup)
    {
      ...
      var type = new ComponentType(typeof(CancelActionAction));
      ...
      foreach (var entity in entities)
      {
        if (isZeroSized) {
          ...
          var action = default(CancelActionAction);
