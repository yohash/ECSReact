...
namespace ECSReact.Samples.BattleSystem
{
  ...
  public partial struct UITargetSelectionReducer_System : ISystem
  {
    ...
    private ComponentLookup<SelectTargetAction> actionLookup;
    ...
    public void OnCreate(ref SystemState state)
    {
      ...
      actionLookup = state.GetComponentLookup<SelectTargetAction>(isReadOnly: true);
    ...
    private void ProcessActions(
      ...
      ComponentLookup<SelectTargetAction> actionLookup)
    {
      ...
      var type = new ComponentType(typeof(SelectTargetAction));
      ...
      foreach (var entity in entities)
      {
        if (isZeroSized) {
          ...
          var action = default(SelectTargetAction);
