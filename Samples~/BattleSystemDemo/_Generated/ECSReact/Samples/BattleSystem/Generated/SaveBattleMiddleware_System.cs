...
namespace ECSReact.Samples.BattleSystem
{
  ...
  /// Action: ECSReact.Samples.BattleSystem.SaveBattleAction
  /// </summary>
  ...
  public partial struct SaveBattleMiddleware_System : ISystem
  {
    ...
    public void OnCreate(ref SystemState state)
    {
      ...
      var queryBuilder = new EntityQueryBuilder(Allocator.Temp)
        .WithAll<ECSReact.Samples.BattleSystem.SaveBattleAction, ActionTag>();
      actionQuery = state.GetEntityQuery(queryBuilder);
      queryBuilder.Dispose();

      state.RequireForUpdate(actionQuery);
      state.RequireForUpdate<ECSReact.Samples.BattleSystem.SaveBattleAction>();
    }
    ...
    private void ProcessMiddleware(ref SystemState state)
    {
      ...
      var type = new ComponentType(typeof(ECSReact.Samples.BattleSystem.SaveBattleAction));
      bool isZeroSized = type.IsZeroSized;

      if (isZeroSized)
      {
        // Zero-sized: no data to read, use default
        var action = default(ECSReact.Samples.BattleSystem.SaveBattleAction);
      ...
      else
      {
        ...
        var actions = actionQuery.ToComponentDataArray<ECSReact.Samples.BattleSystem.SaveBattleAction>(Allocator.Temp);
