...
namespace ECSReact.Samples.BattleSystem
{
  ...
  public partial struct HealthDamageReducer_System : ISystem
  {
    ...
    private ComponentLookup<ApplyDamageAction> actionLookup;
    ...
    public void OnCreate(ref SystemState state)
    {
      ...
      actionLookup = state.GetComponentLookup<ApplyDamageAction>(isReadOnly: true);
    ...
    private void ProcessActions(
      ...
      ComponentLookup<ApplyDamageAction> actionLookup)
    {
      ...
      var type = new ComponentType(typeof(ApplyDamageAction));
      ...
      foreach (var entity in entities)
      {
        if (isZeroSized) {
          ...
          var action = default(ApplyDamageAction);
